    ...
    : TWindow(Menu, name)
{
    ...
    this->gotoXY(10, 0);
    this->writeRow("\xDA\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xBF");
    this->gotoXY(10, 1);
    this->writeRow("\xB3                          \xB3");
    this->gotoXY(10, 2);
    this->writeRow("\xC0\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xC4\xD9");
    ...
    for (u = 0; u < 4; u++)
        base_group->insertGadget(basebutton[u]);
    ...
    for (u = 0; u < 3; u++)
        angle_group->insertGadget(anglebutton[u]);
