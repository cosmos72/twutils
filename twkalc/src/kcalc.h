...
//public slots:
    ...
    /* twin server BUG: we get this only if user middle-clicks outside gadgets/buttons */
	...
	dpy->notifySelection(rq->requestor(), rq->reqprivate(),
			     TW_SEL_TEXTMAGIC, buf, strlen(display_str), display_str);
    }
